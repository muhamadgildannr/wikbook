    ...
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="d-flex justify-content-center justify-content-lg-start">
          <a href="/register" class="btn-get-started scrollto">Registrasi</a>
  ...
  <section id="about" class="about">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row content">
        <div class="col-lg-12">
          <p>
            more than 99 books that you can access on this wikbook web for free we provide books that can be read online  so that knowledge is wider
          </p>
          {{-- <ul>
  ...
  <section id="why-us" class="why-us section-bg">
    <div class="container-fluid" data-aos="fade-up">
      ...
      <div class="row">
            ...
            <ul>
              <li>
                ...
                <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list"> 
                  <p>
                    Dalam novel Bulan Petualangan antara Raib dan kedua kawannya masi berlanjut. Miss Selena akhirnya muncul di sekolah saat beberapa bulan setelah kejadian di klan Bulan. Miss Selena memberikan kabar menyenangkan bagi para murid yang mempunyai jiwa petualang, seperti Raib, Ali dan Seli.
                  </p>
                </div>
              </li>
        ...
        <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("assets/img/nvl-bulan.jpg");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
      </div>
